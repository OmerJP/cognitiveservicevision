...
namespace ComputerVisionPrintedText
{
    static class Program
    {
        ...
        const string subscriptionKey = "4333d68b44954aa6bed65751806a1430";
        ...
        static void Main()
        {
            ...
            string imageFilePath = @"E:\Dropbox\All my things\digitaltext.JPG"; //= Console.ReadLine();
